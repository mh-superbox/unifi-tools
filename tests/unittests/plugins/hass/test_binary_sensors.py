...
from unifi_tools.mqtt.discovery.binary_sensors import HassBinarySensorsDiscovery
...
class TestHappyPathHassBinarySensorsMqttPlugin(TestUniFiApi):
    ...
    def test_discovery_message(self, unifi_api: UniFiAPI):
        ...
        assert message["payload_on"] == "on"
        assert message["payload_off"] == "off"
        ...
        assert topic == "homeassistant/binary_sensor/mocked_unifi-mocked_device_id-port-1/config"
